...
float getFrequency()
{
    ...
    float duration = (float)(currentTime - startTime) / 1000000; //räknar ur duration i sekunder genom att subtrahera starttiden o nuvarande tiden. Därefter omvandlas mikrosekunder till sekunder 
